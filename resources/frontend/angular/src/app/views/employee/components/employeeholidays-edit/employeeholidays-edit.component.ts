...
export class EmployeeholidaysEditComponent implements OnInit {
  ...
  addHolidays() {
    ...
    let { from, to } = this.employeeholidaysForm.value;
  ...
  removeHolidayPeriod(employeeholiday_id: number) {
    this.store.dispatch(
